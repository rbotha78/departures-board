...
The default `esp32dev` PlatformIO environment targets the original SSD1322 OLED board. To build for an ESP32-2432S028R Cheap Yellow Display (CYD), use the `cyd` environment; it enables the integrated ILI9341 TFT, touchscreen/BOOT button input, backlight control, and a native 304x136 display layout with CYD-specific colour and font settings.
